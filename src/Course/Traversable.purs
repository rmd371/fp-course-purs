...
instance composeTraversable :: (Traversable f, Traversable g) =>
...
instance functorProduct :: (Functor f, Functor g) =>
  Functor (Product f g) where
-- Implement the (<$>) function for a Functor instance for Product
  map =
    error "todo: Course.Traversable (<$>)#instance (Product f g)"

instance traversableProduct :: (Traversable f, Traversable g) =>
...
instance functorCoproduct :: (Functor f, Functor g) =>
  Functor (Coproduct f g) where
-- Implement the (<$>) function for a Functor instance for Coproduct
  map =
    error "todo: Course.Traversable (<$>)#instance (Coproduct f g)"

instance traversableCoProduct :: (Traversable f, Traversable g) =>
